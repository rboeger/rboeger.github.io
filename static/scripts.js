...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const carouselImages = [
    ...
    {
      src: "static/building/pc_build1.jpg",
      title: "Custom PC (new components)",
    },
    {
      src: "static/building/pc_build2.jpg",
      title: "Custom PC (used components)",
    },
    { src: "static/building/regulator.jpg", title: "Pressure Regulator" },
    {
      src: "static/building/solenoids.jpg",
      title: "Solenoid Components under Toe Board",
    },
    {
      src: "static/building/switching_system2.jpg",
      title: "Switching System Detail",
    },
    {
      src: "static/building/band_playing.png",
      title: 'My Band "Etale" Performing',
    },
    {
      src: "static/building/bench_routing_and_finish.jpg",
      title: "Organ Bench Routing and Finish",
    },
    { src: "static/building/custom_cat_tree.jpg", title: "Custom Cat Tree" },
    { src: "static/building/mug_rack.jpg", title: "Custom Mug Rack" },
    {
      src: "static/building/custom_coaster_set.jpg",
    ...
    {
      src: "static/building/sideways_offset_chest.jpg",
      title: "Sideways Offset Chest",
    },
  ];
  ...
  document.addEventListener("keydown", (e) => {
    ...
    if (e.key === "Escape") {
      ...
      currentModalIndex =
        (currentModalIndex - 1 + galleryData.length) % galleryData.length;
...
document
  .querySelectorAll(".skill-category, .project-card, .cert-card")
  .forEach((el) => {
    el.style.opacity = "0";
